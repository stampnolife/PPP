        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../news">จัดการข่าวสาร</a></li>
          ...
          <div class="card-body">
            <div class="form-row">
              <div class="form-group col-md-6">
                  <label for="mem_fname">เพิ่มรูปข่าวสาร</label>
            ...
            <table>
              <div class="form-group col-md-2">
                  <label for="news_title">ชื่อข่าวสาร</label>
              ...
              <div class="form-group col-md-2">
                  <label for="submit" style="opacity: 0;">ประเภท</label><br>
