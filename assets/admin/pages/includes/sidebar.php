...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <span class="brand-text font-weight-light text-center d-block">PhomPongPanmai</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <center>
          <a  class="d-block h4"><?php echo $_SESSION['mem_fname']?></a>
          <a  class="d-block h6">  สถานะ <?php if($_SESSION['mem_status']=="admin"){ 
    echo "Administrator";
}
?></a>
