        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="../stores">จัดการสินค้า</a></li>
          ...
          <div class="card-body">
            <div class="form-row">
              <div class="form-group col-md-6">
                  <label for="mem_fname">เพิ่มรูปสินค้า</label>
            ...
            <table>
              ...
              <div class="form-group col-md-4">
                  <label for="submit" style="opacity: 0;">ประเภทสินค้า</label><br>
              </div>
              <div class="form-group col-md-12">
