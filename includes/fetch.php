...
$username = "root";
$password = "";
$conn = mysqli_connect($servername, $username, $password,"ppp_db");
        ...
        <div class="row">
          <div class="card-deck ">
            ...
            <?php while ($row = mysqli_fetch_array($result)) { ?>
              <div class="col-xs-4" style="padding: 20px;padding-left: 90px;">
                ...
                <div class="card card-5 " data-toggle="modal" data-target="#myModal<?php echo $row["product_id"]; ?>">
                  ...
                  <p class="card-text">
                    <form action="includes/addcart.php" method="post">
                      ...
                      <button type="submit" class="btn btn-danger btn-lg btn-block" style="padding-top: 15px;padding-bottom: 15px;" name="addcart">เพิ่มลงตะกร้า <i class="fas fa-shopping-cart fa-1x"></i></button>
                    </form>
                    <!-- /////////////////////  -->
                </div>
                <br><br><br>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form action="includes/addcart.php" method="post">
                          <input type="hidden" name="product_id" value="<?php echo $row['product_id']; ?>">
                          <button type="submit" class="btn btn-danger btn-lg btn-block" style="padding-top: 15px;padding-bottom: 15px;" name="addcart">เพิ่มลงตะกร้า <i class="fas fa-shopping-cart fa-1x"></i></button>
                          <button type="submit" class="btn btn-success btn-lg btn-block" style="padding-top: 15px;padding-bottom: 15px;" name="addcart">ซื้อ<i class="fas fa-shopping-cart fa-1x"></i></button>
                        </form>
                      </div>
                    </div>
                    <!-- Modal footer -->
