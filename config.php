...
if($lang == 'th')
{
    ...
    $Service = "บริการ";
    $Freeshipping = "จัดส่ง";
    $Support24hr = "ดูแลให้คำแนะนำ";
    $CashonDelivery = "ราคาถูก";
    $Contact = "ติดต่อ";
    $faddress = "ต.คลองจินดา ภ.สามพราน จ.นครปฐม 73110 ";
    $femail = "Paulnook27@gmail.com";
    $ftel = "080-938-4980";
    ...
    $r50= "ค่าจัดส่ง / 50 บาทต่อชิ้น";
    // $e80= " Ems / 80 ต่อชิ้น";
    $historys="เว็บไซต์นี้สร้างขึ้นมาเพื่อเพิ่มความสะดวกสะบายในการซื้อต้นไม้ ";
    $map="แผนที่";
...
else if($lang == 'en')
{
    ...
    $Contact = "Contact";
    $faddress = "Khlong Chinda, Sampran, Nakhon Pathom, 73110";
    $femail = "Paulnook27@gmail.com";
    $ftel = "080-938-4980";
    $lusername = "Username";
    $lpassword = "Password"; 
    ...
    $historys="This website was created to make it easier for you to buy plants.";
    $map="Map";
    $profile="Profile";
    $user="Username";
    $name="Name";
