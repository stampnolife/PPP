      ...
      <div class="modal-content">
        ...
        <form class="form col-12" id="formRegister" method="post" action="php/register_process.php">
              ...
              <div class="input-group-text"><i class="fas fa-address-card size-7"></i></i></div>
                <textarea name="mem_address" rows="3" class="form-control"placeholder="โปรดใส่ที่อยู่"></textarea>
              </div>
              ...
              <div class="form-group mb-2 mr-sm-2">
                  <center>  
                    ...
                    <!-- worawin。tk -》6LezDdoUAAAAAKzer766-7kq-7rCZ1A2V18TkPRC -->
                      <div class="g-recaptcha" data-callback="recaptchaCallback" data-sitekey="6LeaDNoUAAAAAED1fOQQkl9VrcwT2ZxB_sKgs7X4"></div>
                  </center>
              </div>
